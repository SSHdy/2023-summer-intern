...
<style>
#repair-year .query-box {
  margin-bottom: 20px;
}
#repair-year .query-item {
  font-size: 16px;
  height: 40px;
  line-height: 40px;
  float: left;
...
#repair-year .query-item > div {
  float: left;
}
#repair-year .query-item > .query-input {
  width: calc(100% - 80px);
}
#repair-year .query-input .el-input__inner {
  height: 32px;
}
</style>
