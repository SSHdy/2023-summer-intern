...
<style>
#handle_year .query-box {
  margin-bottom: 20px;
}
#handle_year .query-item {
  font-size: 16px;
  height: 40px;
  line-height: 40px;
  float: left;
...
#handle_year .query-item > div {
  float: left;
}
#handle_year .query-item > .query-input {
  width: calc(100% - 80px);
}
#handle_year .query-input .el-input__inner {
  height: 32px;
}
</style>
