...
import com.ryzw.houseauthority.entity.KeycloakProperties;
...
public class Swagger2 {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.ryzw.houseauthority.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("宜昌办公用户系统 Rest API")
                .description("宜昌办公用户系统认证后台API接口文档")
                .version("1.0")
                .build();
    }
